...
<!-- Animated Title -->
<h1 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Righteous&size=35&duration=4000&pause=1000&color=00D9A3&center=true&vCenter=true&width=500&lines=Hey+%F0%9F%91%8B+I'm+Joseph+Maina;Full+Stack+Developer;Solutions+Architect;CEO+%26+Founder+of+Azuri;Let's+Build+Together!" alt="Typing SVG" />
</h1>
...
class Developer {
  constructor() {
    this.name = "Joseph Maina";
    this.location = "Nairobi, Kenya 🇰🇪";
    this.company = "Azuri - CEO & Founder";
    this.workExperience = "5+ Years";
    this.projectsDelivered = 20;
  }
  
  get skills() {
    return {
      languages: ["JavaScript", "TypeScript", "SQL", "Python"],
      frontend: ["React", "Next.js 15", "Tailwind CSS", "Redux"],
  ...
  get currentMission() {
    return "Transforming innovative ideas into scalable digital solutions 🚀";
  }
}

const joseph = new Developer();
console.log(joseph.currentMission);
```
...
current_role: Founder & CEO at Azuri
...
<p>
  ...
  <img alt="M-Pesa" src="https://img.shields.io/badge/M--Pesa-00A859?style=for-the-badge&logoColor=white"/>
  <img alt="Clerk" src="https://img.shields.io/badge/Clerk-6C47FF?style=for-the-badge&logoColor=white"/>
...
<table align="center">
  <tr>
    <td align="center" width="200">
      ...
      <br/><sub>Modern, responsive websites</sub>
      <br/><br/>
    </td>
    <td align="center" width="200">
      <br/>
      <strong>📱 Mobile Apps</strong>
      <br/><sub>iOS & Android applications</sub>
      <br/><br/>
    </td>
    <td align="center" width="200">
      <br/>
      <strong>☁️ Cloud Solutions</strong>
    ...
    <td align="center" width="200">
      ...
      <br/><sub>Tailored business solutions</sub>
      <br/><br/>
    </td>
  </tr>
</table>
...
|-----------|-------------|
| 💼 **Enterprise Solutions** | Large-scale applications for businesses |
| 🏥 **Healthcare Tech** | Digital health platforms & management systems |
| ⛽ **Fuel Management** | Advanced fuel tracking & analytics systems |
| 📊 **Data Analytics** | Business intelligence & reporting tools |
| 🔐 **Security First** | End-to-end encrypted solutions |
...
<p align="center">
  <a href="https://www.linkedin.com/in/joseph-mainajm">
    <img src="https://img.shields.io/badge/-Joseph_Maina-0077B5?style=for-the-badge&logo=Linkedin&logoColor=white"/>
  </a>
  <a href="mailto:mainajm254@gmail.com">
    <img src="https://img.shields.io/badge/-mainajm254@gmail.com-D14836?style=for-the-badge&logo=Gmail&logoColor=white"/>
  </a>
...
| 🤝 **Collaborations** | ✅ Open |
| 💼 **Full-time Opportunities** | 🔍 Selective |
| 🎓 **Mentorship** | ✅ Happy to Help |
| 🎤 **Speaking Engagements** | ✅ Interested |
  
<br/>
  
**📍 Location:** Nairobi, Kenya 🇰🇪  
**📞 Phone:** +254 702 156146  
**🌐 Website:** [azuritek.com](https://www.azuritek.com)
...
<sub>Built with ❤️ by Joseph Maina</sub>
